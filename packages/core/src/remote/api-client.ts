...
/** GET /cli/deleted-doc-ids */
export async function pullDeletedDocIds(config: ApiClientConfig): Promise<string[]> {
  return request<string[]>(config, 'GET', '/cli/deleted-doc-ids');
}
